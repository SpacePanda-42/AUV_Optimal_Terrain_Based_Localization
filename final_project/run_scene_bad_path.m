...
%     vel_meas = 10 + mvnrnd(0, 0.05^2); % The AUV velocity is 10 by default. Assuming each simulation step is one second. Using same velocity noise as the IMU
    vel_meas = sqrt(200) + mvnrnd(0, 0.05^2); % VELOCITY FOR STRAIGHT TRAJECTORY
...
save straight_mu_est_hist_test2.mat mu_hist
save straight_true_path_test2.mat trajectory
